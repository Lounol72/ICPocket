...
\lfoot\fancyfoot{\footnotesize *Pokemon:le jeu sera présenter dans la suite du rapport\\*Sprite: image 2D utilisé dans les jeux vidéo\\*ICmon: contraction de l'expression « Institut Claude chappe » et « Monstre »\\*Lore: histoire d'un jeu vidéo\\*deadline: date limite\\}
\newpage
\section{Conception}
...
\subsection{Annexe : Tables des types}
 \begin{figure}[h]
    \centering
    \includegraphics[width=1\textwidth]{DiagrammeType.png} % Augmenté à 90% de la largeur du texte
